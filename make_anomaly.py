...
from anomaly_generator import llm_generated_contextual_anomaly_generator, traditional_contextual_anomaly_generator, global_anomaly_generator, dummy_anomaly_generator, structural_anomaly_generator
...
if __name__ == "__main__":
    ...
    parser.add_argument("--anomaly_num", type=int, default=100)
    ...
    print(data)
    save_data(data, args.output_dir, dataset_name, anomaly_type, n)