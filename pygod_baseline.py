...
import torch
from pygod.detector import AdONE, ANOMALOUS, AnomalyDAE, CoLA, CONAD, DOMINANT, DONE, OCGNN, ONE, Radar
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str, default='cora_fixed_sbert_2_100')
