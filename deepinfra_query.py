...
def call_with_retry(user_prompt, system_prompt, index, model_name, api_key, temperature) -> str:
    """
    Call the deepinfra api with exponential backoff
    """
    count = 0
...
def inference_on_deepinfra(testing_data: List[Dict], system_prompt: str, model_name: str, api_key: str, temperature: float) -> List[Dict]:
    """
    Inference on the deepinfra api, with parallel threads
